...
public class NbaTeamStatsDeserializer extends StdDeserializer<List<NbaTeamStatistic>> {
    public NbaTeamStatsDeserializer() {
        this(null);
    }

    public NbaTeamStatsDeserializer(Class<?> vc) {
        super(vc);
    }
